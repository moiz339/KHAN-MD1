...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~5LFAwAyL#1nVjAAmtxuJRn2Fy_6nG10TVvvYKVE8BR15V8IQb9Ng",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "917849917350",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Mr Tohid",           // Owner's name
    DEV: process.env.DEV || "917849917350",                     // Developer's contact number
    DEVELOPER_NUMBER: '917849917350@s.whatsapp.net',            // Developer's WhatsApp ID
